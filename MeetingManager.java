...
public class MeetingManager {
	...
	public boolean editMeeting(Meeting meetingToAdd) {
		if (meetingCanBeAdded(meetingToAdd)) {
			loggedInEmployee.getDiary().add(meetingToAdd);
			return true;
		}
	 ...
	 * @return true: meeting can be added, false: meeting cannot be added
	 */
	private boolean meetingCanBeEdited(Meeting meetingToCheck) {
	 ...
	 * currently logged in).
	 * 
	 * @param meeting reference of the meeting to be deleted
	 */
	public void deleteMeeting(Object meeting) {
		loggedInEmployee.getDiary().remove(meeting);
	}
