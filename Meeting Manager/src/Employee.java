...
public class Employee {
	...
	public void addNewMeeting() {	//TODO for the love of god someone design a better system than this
		int day = Function.inputInt("Day");
		int month = Function.inputInt("Month");
		int year = Function.inputInt("Year");
		int startHour = Function.inputInt("Start hour");
		int startMinute = Function.inputInt("Start minute");
		int endHour = Function.inputInt("End hour");
		int endMinute = Function.inputInt("End minute");
		String title = Function.inputString("Title");
		String description = Function.inputString("Description");
		add(day, month, year, startHour, startMinute, endHour, endMinute, description, title);
	}
	
	private void add(int day, int month, int year, int startHour, int startMinute, int endHour, int endMinute, String description, String title) {
