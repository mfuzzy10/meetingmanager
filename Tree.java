...
public class Tree {
	 ...
	 */
	public void addToTree(TreeNode node, TreeNode parentNode) {
		if(getRoot() == null) {
			setRoot(node);
			return;
		}
		if(node.getUsername().compareTo(parentNode.getUsername()) < 0) {
			if(parentNode.getLeft() == null) {
				...
				addToTree(node, parentNode.getLeft());
			}
		}
		else{
			if(parentNode.getRight() == null) {
				...
				addToTree(node, parentNode.getRight());
			}
		}
	}
...
//	}
	 ...
	 */	
	public Boolean isInTree(String username, TreeNode parentNode) {
		if(parentNode == null) {
			return false;
		}
			...
			return isInTree(username, parentNode.getRight());
		}
		else if(username.compareTo(parentNode.getUsername()) < 0) {
			return isInTree(username, parentNode.getLeft());
		}
		return false;		
	}
	 ...
	 */	
//	public TreeNode findInTree(int id, TreeNode parentNode) {
//		if(parentNode == null) {
//			TreeNode deadNode = new TreeNode(0, id, null, null);
//			return deadNode;
//		}
//		else if(id == parentNode.getID()) {
//			return parentNode;
//		}
//		else if(id > parentNode.getID()) {
//			return findInTree(id, parentNode.getRight());
//		}
//		else if(id < parentNode.getID()) {
//			return findInTree(id, parentNode.getLeft());
//		}
//		return parentNode;
//	}
