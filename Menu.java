...
public class Menu {
	...
	Stack<Meeting> undoMeeting = new Stack<Meeting>();
	...
	public void displayUserOptions() {
		...
		System.out.println("5) Suggest Meeting");
		System.out.println("6) Availability Search");
		System.out.println("7) View Meeting Suggestions Made");
		System.out.println("8) Cancel Meeting Suggestion Made");
		System.out.println("9) View Meeting Suggestions Received");
		System.out.println("10) Respond to Meeting Suggestion Received");
		System.out.println("12) View All Employees");
	...
	public void displayAdminOptions() {
		displayUserOptions();
		System.out.println("14) Add Employee");
		System.out.println("15) Remove Employee");
	}
		...
		while (true) {
			...
			if (manager.getLoggedInEmployee() == null) {
				...
				while (manager.getLoggedInEmployee() != null) {
					...
					case "2":
						editMeeting(); //Allows previously added meetings to be altered
						break;
					case "3":
						viewAllMeetings();
						break;
...
//						viewAllMeetingSuggestionsMade();
	...
	public void editMeeting() {
		...
		if(!manager.getLoggedInEmployee().getDiary().isEmpty()) {
			viewAllMeetings();
			System.out.println("Choose a meeting you would like to edit");
			...
			System.out.println("You have no scheduled meetings to edit");
		}
		System.out.println("");
		addMeeting();
	}
	public void undoMeeting() {
		if(undoMeeting==null) {
			System.out.println("There are currently no things to undo.");
		}
		else {
			Meeting meeting = new Meeting(null, null, null, null);
			int choice = undoAction.pop();
			meeting = undoMeeting.pop();
			if(choice==1) {
	...
	public void deleteMeeting() {
		...
		if(!manager.getLoggedInEmployee().getDiary().isEmpty()) {
			...
			int meetingIndex = UserInput.inputInt() - 1;
			Meeting meetingToDelete = manager.getLoggedInEmployee().getDiary().get(meetingIndex);
			undoMeeting.push(meetingToDelete);
			undoAction.push(2);
			manager.deleteMeeting(meetingToDelete);
		}
		else {
